...
zcat < ~/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F, '{print $7}' | sort | uniq -c | sort -nr

zcat < ~/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F, '{print $8}' | sort | uniq -c | sort -nr

zcat < ~/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F, '{print $9}' | sort | uniq -c | sort -nr
```
