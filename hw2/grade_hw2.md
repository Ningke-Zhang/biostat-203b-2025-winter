...
- Q1 (12/20)
    - **Incorrect claim about the  data type.** (-2 pts)
    - **Please specify appropriate data type to reduce the size of tibble.** (-6 pts)
...
-   Do not put auxiliary and big data files into version control. 
    - **No need to put extra project file.** (-2 pts)
